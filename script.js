...
window.addEventListener("pointerdown", updateFromEvent, { passive: false });
window.addEventListener("pointermove", updateFromEvent, { passive: false });
window.addEventListener("pointerup", releasePointer, { passive: true });
window.addEventListener("pointercancel", releasePointer, { passive: true });
window.addEventListener("pointerleave", releasePointer, { passive: true });
window.addEventListener("touchstart", updateFromTouch, { passive: false });
window.addEventListener("touchmove", updateFromTouch, { passive: false });
